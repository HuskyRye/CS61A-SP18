...
def find_centroid(cluster):
    ...
    return [mean(latitudes), mean(longitude)]
    # END Question 5
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        list_of_clusters = group_by_centroid(restaurants, centroids)
        centroids = [find_centroid(clusters) for clusters in list_of_clusters]
        # END Question 6
        n += 1
    return centroids
...
def rate_all(user, restaurants, feature_fns):
    ...
    for restaurant in restaurants:
        ...
        if restaurant in reviewed:
            restaurants_rating[name] = user_rating(user, name)
        else:
            restaurants_rating[name] = predictor(restaurant)
